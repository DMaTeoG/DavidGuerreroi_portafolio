...
const ExperienceSection = ({ data }: ExperienceSectionProps) => (
  ...
  >
    <div className="pointer-events-none absolute -left-24 top-24 h-64 w-64 rounded-full bg-rose-200/40 blur-3xl dark:hidden" aria-hidden />
    <div className="pointer-events-none absolute -right-16 bottom-10 h-56 w-56 rounded-full bg-rose-300/30 blur-3xl dark:hidden" aria-hidden />
